...
namespace HealthFit.DataAccess.Repository
{
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        public Repository(HealthyShopContext db)
        {
            _db = db;
            this.dbSet = _db.Set<T>();
            //_db.Categories == dbSet
            //_db.Products.Include(u => u.Categories);
        ...
        public List<T> GetAll(Expression<Func<T, bool>>? filter, string? includeProperties = null)
        {
